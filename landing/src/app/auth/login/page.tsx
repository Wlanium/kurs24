...
function LoginContent() {
  ...
  useEffect(() => {
    ...
    if (message === 'registration-success-free') {
      setSuccessMessage('✅ Registrierung erfolgreich! Sie können sich jetzt anmelden.')
    } else if (message === 'registration-success-payment') {
      setSuccessMessage(`✅ Registrierung erfolgreich! Melden Sie sich an und upgraden Sie auf den ${plan} Plan.`)
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 text-center">
            ...
            <h1 className="text-2xl font-bold text-white">Royal Academy K.I.</h1>
            <p className="text-blue-100 mt-2">Bei Ihrem Konto anmelden</p>
          </div>
